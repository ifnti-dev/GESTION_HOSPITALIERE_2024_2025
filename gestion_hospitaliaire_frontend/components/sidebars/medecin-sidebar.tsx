...
export function MedecinSidebar({ children }: MedecinSidebarProps) {
  ...
  const menuItems = [
    ...
    //   icon: <Pill className="h-5 w-5" />,
    //   href: "/dashboard/medecin/traitements",
    //   gradient: "from-green-500 to-blue-500",
    // },
    // {
    //   title: "Observations",
    //   icon: <FileText className="h-5 w-5" />,
    //   href: "/dashboard/medecin/observations",
    //   gradient: "from-purple-500 to-blue-500",
    // },
    // {
    //   title: "Références/Orientations",
    //   icon: <UserCheck className="h-5 w-5" />,
    //   href: "/dashboard/medecin/referrals",
    //   gradient: "from-orange-500 to-red-500",
    // },
    // {
    //   title: "Planning",
    //   icon: <Calendar className="h-5 w-5" />,
    //   href: "/dashboard/medecin/planning",
    //   gradient: "from-blue-500 to-indigo-600",
    // },
  ]
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div
        ...
        w-80 bg-gradient-to-br from-blue-50 via-white to-cyan-50
      ...
      >
        {/* Header */}
        <div className="relative p-6 bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 overflow-hidden">
        ...
        {/* Footer */}
        <div className="p-6 border-t border-blue-100 bg-gradient-to-r from-blue-50/50 to-cyan-50/50">
          <DropdownMenu>
