...
import { CreatePatientModal } from "@/components/modals/medical/create-patiente" // Correction du nom d'import
...
export default function SageFemmePatientesPage() {
  ...
  const hasRiskFactors = (dossier: DossierGrossesse) => {
    return (
      ...
      (dossier.antecedentsChirurgicaux && dossier.antecedentsChirurgicaux.length > 0) ||
      dossier.statutSerologieHiv === "Positif" ||
      dossier.statutSerologieSyphilis === "Positif" ||
      (dossier.nombreGrossesses && dossier.nombreGrossesses > 5) ||
  ...
  const getStatutBadge = (dossier: DossierGrossesse) => {
    ...
    const weeks = gestationalAge.split(" ")[0]
  ...
  const getRiskFactorsDisplay = (dossier: DossierGrossesse) => {
    ...
    if (dossier.nombreGrossesses && dossier.nombreGrossesses > 5) {
  ...
  return (
    <DashboardLayout>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-center">
                          <div className="text-lg font-semibold text-blue-600">
                            G{dossier.nombreGrossesses || 0}P{dossier.nombreAccouchements || 0}
                          </div>
                        ...
                        <div className="text-center">
                          <div className="text-lg font-semibold text-green-600">
                            {dossier.datePrevueAccouchement
                              ? Math.ceil(
      ...
      {/* Correction du nom du composant modal */}
      <CreatePatientModal
