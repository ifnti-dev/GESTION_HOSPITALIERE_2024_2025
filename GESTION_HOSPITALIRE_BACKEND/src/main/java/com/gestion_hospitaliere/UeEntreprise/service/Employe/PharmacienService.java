...
public class PharmacienService {
    ...
    public Pharmacien mettreAJourPharmacien(Long id, Pharmacien pharmacienDetails) {
        ...
        if (pharmacienOptional.isPresent()) {
            ...
            pharmacien.setNomUtilisateur(pharmacienDetails.getNomUtilisateur());
            pharmacien.setPassword(pharmacienDetails.getPassword());
            pharmacien.setNom(pharmacienDetails.getNom());
            pharmacien.setPrenom(pharmacienDetails.getPrenom());
            pharmacien.setEmail(pharmacienDetails.getEmail());
            pharmacien.setRoles(pharmacienDetails.getRoles());

            // ✅ Mise à jour des champs spécifiques à Pharmacien
